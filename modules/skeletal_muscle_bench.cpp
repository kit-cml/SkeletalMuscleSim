#include "skeletal_muscle_bench.hpp"

#include <types/cellmodels/shorten_ocallaghan_davidson_soboleva_2007.hpp>
...
int skeletal_muscle_bench(const Parameter *p_param)
{
