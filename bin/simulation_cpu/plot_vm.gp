...
set output 'results/Vm_Skeletal_Muscle.png'

# Set plot title and axis labels
set title 'Vm Shorten Skeletal Muscle'
set xlabel 'Time (ms)'
...
plot 'results/time_series_Shorten.csv' using 1:2 with lines linestyle 1 title 'vS', \
     'results/time_series_Shorten.csv' using 1:2 with lines linestyle 2 title 'vT'
